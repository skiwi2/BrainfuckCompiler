...
public class IntermediateCodeGeneratorTest {
    ...
    public void testGenerateAST() throws Exception {
        ...
        rootNode.addChild(new ASTNode(new MemoryPointerChangeExpression(1)));
        rootNode.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        rootNode.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        rootNode.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        rootNode.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        rootNode.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        ...
        loopNode1.addChild(new ASTNode(new MemoryValueChangeExpression(-1)));
        loopNode1.addChild(new ASTNode(new MemoryPointerChangeExpression(-1)));
        loopNode1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        ...
        loopNode2.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        ...
        loopNode3.addChild(new ASTNode(new MemoryPointerChangeExpression(1)));
        ...
        loopNode3Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(-1)));
        loopNode3Inner1.addChild(new ASTNode(new MemoryPointerChangeExpression(1)));
        loopNode3Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode3Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode3Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode3Inner1.addChild(new ASTNode(new MemoryPointerChangeExpression(-1)));
        ...
        loopNode4.addChild(new ASTNode(new MemoryPointerChangeExpression(1)));
        ...
        loopNode4Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
        loopNode4Inner1.addChild(new ASTNode(new MemoryPointerChangeExpression(1)));
        loopNode4Inner1.addChild(new ASTNode(new MemoryValueChangeExpression(1)));
